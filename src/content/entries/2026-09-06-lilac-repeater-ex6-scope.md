...
- **Recording at unity.** DRY sets the monitoring level only. Input is recorded at full level wherever the fader sits.
- **Trimming on the faders.** FDBK trims the loop start and SPEED trims the end, with nothing held. Hold FUNC for the original global feedback and tempo.
- **Per-track speed.** Hold one track button and move SPEED for a continuous 0.5×–2× multiplier on that track alone. Session-only — saved samples are untouched.
- **Menu taps on release.** So holding a track button for speed can't trip a menu parameter first.
- **Scope splash.** An oscilloscope trace drawing `EX6` in place of the original startup logo.

<figure class="panel-plate wide">
<div id="lilac-original-start">
<svg style="display:block;width:min(100%,464px);height:auto;margin:0 auto" viewBox="0 0 464 984" role="img" aria-labelledby="original-start-title">
<title id="original-start-title">Original LilaC panel with START and END faders in white, and FDBK and BPM beneath in gold</title>
<image width="464" height="984" href="/moodboards/lilac-repeater-ex6-scope/panel-ex6.png"/>
<rect x="17" y="450" width="81" height="45" fill="#0b0b0b"/>
<text x="55" y="476" text-anchor="middle" fill="#f2f2f2" font-family="Arial, sans-serif" font-size="22" font-weight="700" font-style="italic">START</text>
<text x="55" y="495" text-anchor="middle" fill="#dfaa2c" font-family="Arial, sans-serif" font-size="15" font-weight="700" font-style="italic">FDBK</text>
<rect x="377" y="450" width="86" height="45" fill="#0b0b0b"/>
<text x="420" y="476" text-anchor="middle" fill="#f2f2f2" font-family="Arial, sans-serif" font-size="22" font-weight="700" font-style="italic">END</text>
<text x="420" y="495" text-anchor="middle" fill="#dfaa2c" font-family="Arial, sans-serif" font-size="15" font-weight="700" font-style="italic">TRK BMP</text>
<text x="55" y="760" text-anchor="middle" fill="#f2f2f2" font-family="Arial, sans-serif" font-size="12" font-weight="700" font-style="italic">MON ONLY</text>
<rect x="116" y="299" width="244" height="132" rx="10" fill="#000000"/>
<image x="118" y="305" width="240" height="120" href="data:image/png;base64," aria-label="EX6 oscilloscope startup image with 2.0-EX6 version label"/>
<g id="vector-control-labels">
<rect x="30" y="154" width="52" height="32" fill="#0b0b0b"/><text x="56" y="178" text-anchor="middle" fill="#f2f2f2" font-family="Arial, sans-serif" font-size="22" font-weight="700" font-style="italic">L</text><rect x="121" y="154" width="52" height="32" fill="#0b0b0b"/><text x="147" y="178" text-anchor="middle" fill="#f2f2f2" font-family="Arial, sans-serif" font-size="22" font-weight="700" font-style="italic">R</text><rect x="202" y="154" width="72" height="32" fill="#0b0b0b"/><rect x="207" y="157" width="62" height="24" rx="12" fill="#f2f2f2"/><text x="238" y="177" text-anchor="middle" fill="#0b0b0b" font-family="Arial, sans-serif" font-size="22" font-weight="700" font-style="italic">CLK</text><rect x="293" y="154" width="72" height="32" fill="#0b0b0b"/><rect x="298" y="157" width="62" height="24" rx="12" fill="#f2f2f2"/><text x="329" y="177" text-anchor="middle" fill="#0b0b0b" font-family="Arial, sans-serif" font-size="22" font-weight="700" font-style="italic">L</text><rect x="384" y="154" width="72" height="32" fill="#0b0b0b"/><rect x="389" y="157" width="62" height="24" rx="12" fill="#f2f2f2"/><text x="420" y="177" text-anchor="middle" fill="#0b0b0b" font-family="Arial, sans-serif" font-size="22" font-weight="700" font-style="italic">R</text><rect x="111" y="245" width="72" height="33" fill="#0b0b0b"/><text x="147" y="269" text-anchor="middle" fill="#f2f2f2" font-family="Arial, sans-serif" font-size="22" font-weight="700" font-style="italic">REC</text><rect x="202" y="245" width="72" height="33" fill="#0b0b0b"/><text x="238" y="269" text-anchor="middle" fill="#f2f2f2" font-family="Arial, sans-serif" font-size="22" font-weight="700" font-style="italic">CLK</text><rect x="293" y="245" width="72" height="33" fill="#0b0b0b"/><text x="329" y="269" text-anchor="middle" fill="#f2f2f2" font-family="Arial, sans-serif" font-size="22" font-weight="700" font-style="italic">RST</text><rect x="23" y="721" width="64" height="28" fill="#0b0b0b"/><text x="55" y="742" text-anchor="middle" fill="#f2f2f2" font-family="Arial, sans-serif" font-size="22" font-weight="700" font-style="italic">DRY</text><rect x="115" y="721" width="64" height="28" fill="#0b0b0b"/><text x="147" y="742" text-anchor="middle" fill="#f2f2f2" font-family="Arial, sans-serif" font-size="22" font-weight="700" font-style="italic">1</text><rect x="206" y="721" width="64" height="28" fill="#0b0b0b"/><text x="238" y="742" text-anchor="middle" fill="#f2f2f2" font-family="Arial, sans-serif" font-size="22" font-weight="700" font-style="italic">2</text><rect x="297" y="721" width="64" height="28" fill="#0b0b0b"/><text x="329" y="742" text-anchor="middle" fill="#f2f2f2" font-family="Arial, sans-serif" font-size="22" font-weight="700" font-style="italic">3</text><rect x="388" y="721" width="64" height="28" fill="#0b0b0b"/><text x="420" y="742" text-anchor="middle" fill="#f2f2f2" font-family="Arial, sans-serif" font-size="22" font-weight="700" font-style="italic">4</text><rect x="14" y="911" width="82" height="31" fill="#0b0b0b"/><text x="55" y="934" text-anchor="middle" fill="#f2f2f2" font-family="Arial, sans-serif" font-size="22" font-weight="700" font-style="italic">FUNC</text><rect x="106" y="911" width="82" height="31" fill="#0b0b0b"/><text x="147" y="934" text-anchor="middle" fill="#f2f2f2" font-family="Arial, sans-serif" font-size="22" font-weight="700" font-style="italic">LOOP</text><rect x="107" y="942" width="80" height="21" fill="#0b0b0b"/><text x="147" y="958" text-anchor="middle" fill="#dfaa2c" font-family="Arial, sans-serif" font-size="16" font-weight="700" font-style="italic">SYSTEM</text><rect x="197" y="911" width="82" height="31" fill="#0b0b0b"/><text x="238" y="934" text-anchor="middle" fill="#f2f2f2" font-family="Arial, sans-serif" font-size="22" font-weight="700" font-style="italic">CLEAR</text><rect x="198" y="942" width="80" height="21" fill="#0b0b0b"/><text x="238" y="958" text-anchor="middle" fill="#dfaa2c" font-family="Arial, sans-serif" font-size="16" font-weight="700" font-style="italic">UNDO</text><rect x="288" y="911" width="82" height="31" fill="#0b0b0b"/><text x="329" y="934" text-anchor="middle" fill="#f2f2f2" font-family="Arial, sans-serif" font-size="22" font-weight="700" font-style="italic">REC</text><rect x="289" y="942" width="80" height="21" fill="#0b0b0b"/><text x="329" y="958" text-anchor="middle" fill="#dfaa2c" font-family="Arial, sans-serif" font-size="16" font-weight="700" font-style="italic">AUTO</text><rect x="379" y="911" width="82" height="31" fill="#0b0b0b"/><text x="420" y="934" text-anchor="middle" fill="#f2f2f2" font-family="Arial, sans-serif" font-size="22" font-weight="700" font-style="italic">START</text>
</g>
</svg>
</div>
<figcaption>The panel as EX6 relabels it: white legends are what a fader does with nothing held, gold is the FUNC secondary the module already prints that way.</figcaption>
</figure>
...
.panel-plate { margin: 1.75rem 0; }
.panel-plate figcaption { margin-top: 10px; color: var(--muted); font: 11px var(--mono); text-align: center; }
